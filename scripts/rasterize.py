...
from scannetpp.common.utils.colmap import camera_to_intrinsic
from scannetpp.common.file_io import read_txt_list
from scannetpp.common.scene_release import ScannetppScene_Release
from scannetpp.common.utils.colmap import get_camera_images_poses
...
@hydra.main(version_base=None, config_path="./scannetpp/semantic/configs", config_name="rasterize")
def main(cfg : DictConfig) -> None:
    ...
    # get scene list
    scene_list = os.listdir('./data')#read_txt_list(cfg.scene_list_file)
    ...
    for scene_id in tqdm(scene_list, desc='scene'):
        ...
        if not scene.scans_dir.exists() or not scene.scan_anno_json_path.exists():
            continue
        # read mesh
